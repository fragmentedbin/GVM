...
<div class="privacyContent">
    <div class="container">
        <div>
            ...
            <p>Effective date: December 06, 2019</p>
            <p>Recording Label Grow Vibes Music ("us", "we", or "our") operates Website Grow Vibes Music. This page
                informs
                you of our policies regarding the collection, use and disclosure of personal data when you use our
                Service
                and the choices you have associated with that data. This Privacy Policy is managed by Privacy Policy
                Generator.</p>
            ...
            <ul>
                <li>
                    ...
                    <p>Service means the pages web operated by Recording Label</p>
                </li>
                <li>
            ...
            <p>We use cookies and similar tracking technologies to track the activity on our Service and we hold certain
                ...
                such as beacons, tags and scripts to collect and track information and to improve and analyse our
                Service.
            ...
            <h2>Use of Data</h2>
            <p>Recording Label uses the collected data for various purposes:</p>
            <ul>
                <li>To provide and maintain our Service</li>
                <li>To notify you about changes to our Service</li>
                <li>To allow you to participate in interactive features of our Service when you agreement_for to do so
                </li>
            ...
            <p>Your consent to this Privacy Policy followed by your submission of such information represents your
                agreement
                to that transfer.</p>
            <p>Recording Label will take all the steps reasonably necessary to ensure that your data is treated securely
                and
            ...
            <p>Recording Label may disclose your Personal Data in the good faith belief that such action is necessary
                to:
            </p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Recording Label</li>
            ...
            <ul>
                <li>
                    ...
                    <p>For more information on what type of information Unity Analytics collects, please visit their
                        Privacy
                        Policy page: <a href="https://unity3d.com/legal/privacy-policy" rel="external nofollow noopener"
                            target="_blank">https://unity3d.com/legal/privacy-policy</a></p>
                </li>
            </ul>
            ...
            <p>We do not knowingly collect personally identifiable information from anyone under the age of 18. If you
                are a
                parent or guardian and you are aware that your Child has provided us with Personal Data, please contact
                us.
            ...
            <ul>
                <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="97f0e5f8e0e1fef5f2e4fae2e4fef4d7f0faf6fefefbb9f4f8fa">[email&#160;protected]</a>
                </li>
            </ul>
        </div>
