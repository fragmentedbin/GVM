                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown @if (Route::current()->getName() === 'home')active active-c @endif ">
                        ...
                        <div class="dropdown-menu dropdown-menu-c animate-menu slideIn-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item @if (Route::current()->getName() === 'home')active active-c @endif" href="{{ url('' )}}">Single</a>
                            <a class="dropdown-item @if (Route::current()->getName() === 'ep')active active-c @endif" href="{{ url('' )}}">EP</a>
                            <a class="dropdown-item @if (Route::current()->getName() === 'lp')active active-c @endif" href="{{ url('' )}}">LP</a>
