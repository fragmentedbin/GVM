...
<head>
    ...
    <!-- icon -->
    <link rel="icon" href="{{ secure_asset ('img/gvm-logo.jpg')}}" type="image/x-icon">
    <!-- Font Awesome -->
...
<!-- Bootstrap tooltips -->
{{-- <script type="text/javascript" src="{{secure_asset('js/popper.min.js')}} defer"></script> --}}
...
<script type="text/javascript" src="{{secure_asset('js/style.js')}} defer"></script>

{{-- UNUSED --}}
{{-- <script type="text/javascript" src="{{secure_asset('js/addons/pdfmake.min.js')}} defer"></script>
<script type="text/javascript" src="{{secure_asset('js/addons/vfs_fonts.js')}} defer"></script>
<script type="text/javascript" src="{{secure_asset('js/addons/datatables.min.js')}} defer"></script> --}}
